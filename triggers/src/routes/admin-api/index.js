...
import AdaptorRequest from "../../core/domain/adaptor-request.js";
import TargetRequestsCollector from "../../core/domain/target-requests-collector.js";
...
export default class AdminApi extends Controller {
    ...
    constructor(config, ...middlewares) {
        ...
        this.use('/adaptors', Domain(Adaptor))
        this.use('/adaptor-requests', Domain(AdaptorRequest))
        this.use('/target-requests-collectors', Domain(TargetRequestsCollector))
